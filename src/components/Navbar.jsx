...
export const Navbar = () => {
  ...
  return (
    <div className="border-black bg-black 2xl:mb-3 mb-10 z-10 ">
      <header className="w-full sticky top-0 left-0 right-0 bg-black z-50">
        <nav className="py-6 lg:px-14 px-4 border-b-0 bg-black duration-300">
